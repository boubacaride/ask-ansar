...
interface HadithCategoryResultsProps {
  categoryId: string;
  categoryName: string;
  categoryIcon: string;
...
export function HadithCategoryResults({
  categoryId,
  categoryName,
  categoryIcon,
  categoryColor,
  ...
  const loadHadiths = async () => {
    ...
    try {
      const results = await fetchHadithsByCategory(categoryId, 15);
      setHadiths(results);
