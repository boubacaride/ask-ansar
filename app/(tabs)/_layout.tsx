    ...
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: {
          ...
          borderTopWidth: 1,
          height: Platform.select({ ios: isSmallScreen ? 80 : 88, android: isSmallScreen ? 62 : 70, web: 76 }),
          paddingBottom: Platform.select({ ios: isSmallScreen ? 22 : 28, android: isSmallScreen ? 6 : 10, web: 8 }),
          paddingTop: Platform.select({ ios: isSmallScreen ? 6 : 10, android: isSmallScreen ? 6 : 10, web: 6 }),
          paddingHorizontal: 2,
          elevation: 0,
          shadowColor: '#000',
