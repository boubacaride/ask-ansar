...
const styles = StyleSheet.create({
  ...
  keyboardInner: { flex: 1, overflow: 'hidden' as const },
  gradientBackground: { flex: 1, overflow: 'hidden' as const },
  contentContainer: { padding: 16, paddingBottom: 20 },
  emptyState: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 40, paddingHorizontal: 24 },
  ...
  inputContainer: { borderTopWidth: 1, borderTopColor: '#E5E7EB', backgroundColor: '#FFFFFF', paddingBottom: Platform.select({ ios: 34, android: 16, web: 8 }), shadowColor: '#000', shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 4 },
  ...
  inputWrapper: { paddingHorizontal: Platform.OS === 'web' ? 12 : 20, paddingTop: Platform.OS === 'web' ? 8 : 16 },
